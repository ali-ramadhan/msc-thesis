...
where the second summation is over all $i,j$ pairs where $i \ne j$.

Calculating Hamilton's equations for the system, we get
$$ \dot{\mathbf{r}_i} = \frac{\partial \mathcal{H}}{\partial \mathbf{p}_i} = \frac{\mathbf{p}_i}{m_i} $$
$$ \dot{\mathbf{p}_i} = \frac{\partial \mathcal{H}}{\partial \mathbf{r}_i} = \frac{1}{4\pi\epsilon_0}\sum_{i \ne j} \frac{\mathbf{r}_i - \mathbf{r}_j}{|\mathbf{r}_i - \mathbf{r}_j|^3} $$
