...
F4or some perspective, \citet{Slater15} discuss the computational simulation of ion trajectories for larger systems such as the the 3,5-dibromo-3',5'-difluoro-4'-cyanobiphenyl (\ch{DBrDFCNBph}) molecule, and who interestingly employ a pixel-imaging mass-spectrometry camera for position detection.
