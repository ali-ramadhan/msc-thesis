\chapter{A structural history of molecules}\label{ch:history}
...
\section{Is matter made of discrete particles?}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{gfx/AffinityTable}
  \caption[Geoffroy's Affinity Table.]
  {Geoffroy's Affinity Table. The top row is a list of substances that can combine with all the substances listed below it. Figure from \citet{Geoffroy1718}.}
  \label{fig:affinityTable}
\end{figure}
\clearpage

\section{What do molecules look like?}
