...
\begin{figure}
  ...
  {Reconstruction of \ch{H3+} following foil-induced dissociation. From \citet{Gaillard78}. Reprinted with permission from AAAS.}
\end{figure}
...
$$ \frac{4e^2}{|\mathbf{r}_C - \mathbf{r}_n|} = \frac{|\mathbf{V}_C - \mathbf{V}_n|^2}{2} $$
