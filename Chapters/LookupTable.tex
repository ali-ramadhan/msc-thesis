...
\begin{description}
  \item [Degenerate geometries exist]
  ...
  \item [Precise reconstructions are computationally expensive]
...
\begin{description}
  \item [Finding an initial or first-order solution]
  \item [Finding degenerate regions of phase space quickly]
\end{description}
