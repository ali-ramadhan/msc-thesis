...
A critical issue is quantifying how much uncertainty there is in these molecular geometries. This is a complicated problem we attempt to tackle in chapter \ref{ch:bayesian}.
...
\begin{table}
  ...
  \begin{tabularx}{0.875\textwidth}{cccc}
    ...
    \bottomrule
  \end{tabularx}
  \caption[Autem timeam deleniti usu id]
