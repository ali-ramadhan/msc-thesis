...
% TODO: Slice plot showing degenerate geometries!
...
\begin{figure}
  ...
  \caption[Rainbow plot.]
  {Rainbow plot. Best 200 matches. Each point is colored according to. This same information may be plotted using colormapped volumetric slices or contour slices however due to the angled distribution formed by the spatial sets and the significance of only one or two data points, it becomes very difficult to visually locate the local minima even with angled slices. Another visualization method may be to use convex hulls or alpha shapes to visualize the shape of the set of points}
  \label{fig:rainbow}
\end{figure}
