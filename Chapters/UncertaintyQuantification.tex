...
% We can also see why Bayesian inference is great for inverse problem. The probability of interest for the inverse problem is directly related to the probability of interest for the forward problem.

\subsection{Markov chain Monte Carlo}
\emph{Markov chain Monte Carlo} (MCMC) methods are a class of algorithms for sampling from a probability distribution by constructing a \emph{Markov chain} whose equilibrium distribution is the same as that of the probability distribution we are sampling from.
